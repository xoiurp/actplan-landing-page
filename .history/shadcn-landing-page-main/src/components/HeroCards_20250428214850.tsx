...
const chartData = [
  { month: "Brasil", desktop: 300 },
  { month: "Dinamarca", desktop: 289 },
  { month: "Noruega", desktop: 279 },
  { month: "Grécia", desktop: 220 },
  { month: "Islândia", desktop: 190 }
];
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis 
                    dataKey="month" 
                    tickLine={false} 
                    tickMargin={25}  // aumentar a margem
                    axisLine={false}
                    angle={-45}  // rotacionar o texto
                    textAnchor="end"  // alinhar o texto
                    style={{ fontSize: '7px' }}  // diminuir a fonte
                  />
                  <Tooltip 
