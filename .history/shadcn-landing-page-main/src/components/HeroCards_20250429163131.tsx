  ...
  return (
    <div className="hidden lg:flex gap-4 relative w-[800px] h-[380px]">
      ...
      <div className="flex flex-col gap-1 w-[350px] h-full">
        {/* Gráfico */}
        <Card className="w-full shadow-md bg-white z-10 h-full">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  ...
                  margin={{
                    ...
                    right: 0,
                    left: 10,
                    bottom: 30,  // Aumentado para dar mais espaço para os nomes
                  }}
                >
                  ...
                  <XAxis
                    ...
                    axisLine={false}
                    angle={0}  // rotacionar o texto
                    textAnchor="middle"  // alinhar o texto no centro
          ...
          <CardFooter className="flex-col items-start gap-1 text-sm pt-0 pb-2">
