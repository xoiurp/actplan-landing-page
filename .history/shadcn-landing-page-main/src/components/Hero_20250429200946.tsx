...
export const Hero = () => {
  return (
    <section className="container flex flex-col lg:flex-row items-center justify-between py-20 md:py-32 gap-10 relative overflow-hidden bg-gradient-to-b from-white to-[#E9E9E9]">
